...
<template>
	...
	<div class="grid">
	  <div id="docs">
		...
		<p><button class="outline" :class="{ secondary: !bubble }" @click="bubble = !bubble">bubble</button> <i>Unmade choices float to the top</i></p>
		<p><button class="outline" :class="{ secondary: !peek }" @click="peek = !peek">peek</button> <i>Show scores before completion</i></p>
	      </details>
	    </details>
	  </div>
	</div>
